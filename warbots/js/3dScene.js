  ...
  */  
   ...
   */ 	  
   ...
   function draw() 
   {
        ...
        //END--FOR--TEST---//	
      /* for (aa = 0; aa < arrBots.length; aa++ ){
			if (arrBots[aa].fract == "enemy" && arrBots[aa].health > 0){
				if (Math.random()*100<10 ){
	                arrBots[aa].getHit();					 
				}	
			}
			if (arrBots[aa].fract == "hero" && arrBots[aa].health > 0){
		...
		//$("#debug").html("<p>!!!!!!!!!!!" + camera.position.x + ":" + camera.position.z+ "</p>");
