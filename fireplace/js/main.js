...
appWrapper, uiWrapper, modelsWrapper   
...
const nav = [
  {
    name: 'Brattechelino',
	preview: 'fpl01.jpg',
	linkToModel: 'index.html'
  },
  {
    name: 'Casper',
	preview: 'fpl02.jpg',
	linkToModel: 'fireplace2.html'
  },
  {
    name: 'Flower',
	preview: 'fpl03.jpg',
	linkToModel: 'fireplace3.html'
  }
]

const createNavigationModels = () => {
  modelsWrapper = document.getElementById( 'models-wrapper' )
  nav.forEach( ( elem ) => {
    let wr = document.createElement( 'div' )
	wr.className = 'model-link'
	wr.innerHTML = '<a href = "' + elem.linkToModel + '"><img src="maps/' + elem.preview + '"><br>' + elem.name + '</a>'
	modelsWrapper.appendChild( wr )
  } )
}
...
const resizeWindow = () => {
  ...
  appWrapper.style.height = h + - 150 + 'px'  
  if ( w/h > 2.3 ) { 
